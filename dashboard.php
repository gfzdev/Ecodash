                            ...
                            <div class="suggestions-list">
                                ...
                                <div class="suggestion-item">
                                    ...
                                    <div class="suggestion-content">
                                        <p>Substitua por lâmpadas LED que consomem até 80% menos energia e duram 25 vezes mais.</p>
                                ...
                                <div class="suggestion-item">
                                    ...
                                    <div class="suggestion-content">
                                        <p>Mantenha a temperatura em 23°C. Cada grau abaixo disso aumenta o consumo em 7%.</p>
                                        <div class="suggestion-meta">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-column">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="energy-consumed" step="0.01" min="1" required>
                        </div>
                        
                        <div class="form-group">
                            <label for="energy-cost">Custo (R$)</label>
                            <input type="number" id="energy-cost" step="0.01" min="1" required>
                        </div>
